        ...
        >
            ...
            <div className="container mx-auto px-4 py-32 relative z-10 flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="bg-[#00000085] shadow-lg rounded-lg p-6 ">
                    <h2 className="text-2xl font-bold text-white-700 mb-4">Tìm kiếm xe máy</h2>
                    <form onSubmit={handleSearch} className="space-y-6 w-[385px]">
                        {/* Điểm nhận xe */}
                        <div>
                            <label htmlFor="pickUpLocation" className="block text-sm font-medium text-white-700">
                                Điểm nhận xe
                            </label>
                            <select
                                id="pickUpLocation"
                                ...
                                className="mt-1 block w-full border border-none outline-none p-3"
                                required
                            >
                        ...
                        <div className="flex items-center">
                            ...
                            />
                            <label htmlFor="sameReturn" className="ml-2 text-sm text-white-700">
                        ...
                        {!sameReturn && (
                            <div>
                                <label htmlFor="returnLocation" className="block text-sm font-medium text-white-700">
                                    Điểm trả xe
                                </label>
                                <select
                                    id="returnLocation"
                                    ...
                                    className="mt-1 block w-full border border-none outline-none p-3" required
                                >
                        ...
                        {/* Ngày nhận xe */}
                        <div>
                            <label htmlFor="pickUpDate" className="block text-sm font-medium text-white-700">
                                Ngày nhận xe
                            </label>
                            <input
                                type="date"
