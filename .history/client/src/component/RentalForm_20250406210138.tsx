...
const RentalForm: React.FC = () => {
    ...
    return (
        <div className=" mx-auto p-6 py-32 bg-[#ccc] rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-6 text-center">Thông tin Khách hàng</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label htmlFor="lastName" className="border-[1px solid #ccc] color-[#222] h-[34px] px-2 py-4 w-full outline-none"
                        >
                            Tên
                        </label>
                        <input
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="email" className="border-[1px solid #ccc] color-[#222] h-[34px] px-2 py-4 w-full outline-none"
                        >
                            Email
                        </label>
                        <input
                    ...
                    <div>
                        <label htmlFor="phone" className="border-[1px solid #ccc] color-[#222] h-[34px] px-2 py-4 w-full outline-none"
                        >
                            Số điện thoại
                        </label>
                        <input
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="address" className="border-[1px solid #ccc] color-[#222] h-[34px] px-2 py-4 w-full outline-none"
                        >
                            Địa chỉ
                        </label>
                        <input
                    ...
                    <div>
                        <label htmlFor="city" className="border-[1px solid #ccc] color-[#222] h-[34px] px-2 py-4 w-full outline-none"
                        >
                            Tỉnh / Thành Phố
                        </label>
                        <select
                ...
                {/* Ghi chú */}
                <div>
                    <label htmlFor="note" className="border-[1px solid #ccc] color-[#222] h-[34px] px-2 py-4 w-full outline-none"
                    >
                        Ghi chú bổ sung
                    </label>
                    <textarea
                        ...
                        rows={3}
                        className="w-full border border-gray-300 rounded-lg shadow-sm p-3 text-gray-700 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-300 ease-in-out"
                        required
                    ></textarea>
                </div>
                ...
                <div className="text-center">
                    <button
                        type="submit"
                        className="bg-[#ffc80b] text-black py-2 px-4  font-bold hover:bg-[#e0b800] transition duration-300"
                    >
                        Xác nhận
                    </button>
                </div>
