                ...
                <div key={bike.id} className="box-fields mb-8">
                    <div className="flex flex-wrap car-rental-step-2-box-fields border-1 border-gray-300  shadow rounded-lg p-4">
                        ...
                        <div className="col-md-3 col-sm-3 col-xs-12 car-rental-step-2-image-column">
                            <img
                                src={`http://127.0.0.1:8000/storage/${bike.image} || https://files-europe.caagcrm.com/tenants/1f9a864b-051d-4690-b2ac-218db7244bda/files/xvukur8x-r9e6-pqfk-x0sq-bpw5jnnwvhwf/redirect/1713955457/timestamp?size=1000`}
                                alt={bike.bike_name}
