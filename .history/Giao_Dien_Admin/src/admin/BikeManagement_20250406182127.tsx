...
interface BikeData {
    ...
    status: string;
    image: File | string;
    pick_up_location: string; // Điểm nhận xe
    return_location: string; // Điểm trả xe
}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <input
                        ...
                        value={bikeData.pick_up_location}
                        onChange={handleChange}
                        required
                    />
                    <input
                        ...
                        placeholder="Điểm trả xe"
                        value={bikeData.return_location}
                        onChange={handleChange}
                        required
                    />
                </div>
            ...
            <table className="w-full mt-6 border-collapse border border-gray-200 rounded-lg">
                <thead>
                    <tr className="bg-gray-100">
                        ...
                        <th className="p-2 border">Điểm nhận xe</th>
                        <th className="p-2 border">Điểm trả xe</th>
                ...
                <tbody>
                    {bikeList.map((bike) => (
                        <tr key={bike.id} className="text-center hover:bg-gray-50">
                            ...
                            <td className="p-2 border">{bike.pick_up_location}</td>
                            <td className="p-2 border">{bike.return_location}</td>
