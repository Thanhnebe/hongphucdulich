...
Route::prefix('car-rentals')->group(function () {
    ...
    Route::post('/search', [CarRentalController::class, 'search']);
});
Route::post('/rentals', [CarRentalController::class, 'storeRental']);
Route::get('/locations', [CarRentalController::class, 'getPickUpLocations']);
Route::get('/locations/{pick_up_location_id}/return', [CarRentalController::class, 'getReturnLocations']);
